...
(function() {
  ...
  render = function() {
    var ball, i, j, l, len, len1, m, n, particle, ref6, ref7, ref8;
    cloth.simulate(TIMESTEP);
    ref6 = cloth.particles;
    for (i = l = 0, len = ref6.length; l < len; i = ++l) {
      particle = ref6[i];
    ...
    for (i = m = 0, len1 = balls.length; m < len1; i = ++m) {
      ...
      for (j = n = ref7 = i, ref8 = balls.length - 1; ref7 <= ref8 ? n <= ref8 : n >= ref8; j = ref7 <= ref8 ? ++n : --n) {
        if (j === i) {
          continue;
        }
