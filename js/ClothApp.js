...
(function() {
  var Cloth, ClothParticle, TIMESTEP, TIMESTEP_SQ, axes, camera, cloth, clothFrameMaterial, clothGeo, clothMaterial, clothObj, gravity, gui, initScene, initStats, light, pins, planeGeo, planeMat, planeObj, ref, render, renderer, scene, stats, wind;
  ...
  Cloth = (function() {
    ...
    Cloth.prototype.simulate = function(time, clothFaces, windForce) {
      var constrain, constrains, face, gForce, i, j, k, l, lastTime, len, len1, len2, m, n, normal, particle, particles, pos, ref, ref1, results, tmpForce, xy;
      ...
      for (i = l = 0, ref = constrains.length - 1; 0 <= ref ? l <= ref : l >= ref; i = 0 <= ref ? ++l : --l) {
        constrain = constrains[i];
        this.satisfyConstrains(constrain[0], constrain[1], constrain[2]);
      }
      for (i = m = 0, ref1 = pins.length - 1; 0 <= ref1 ? m <= ref1 : m >= ref1; i = 0 <= ref1 ? ++m : --m) {
        xy = pins[i];
