...
(function() {
  var Hexahedron, PBDParticle, axes, boxBasicMaterial, boxGeometry, boxObj, camera, clock, geometry, geometryTopo, global, gui, h, initScene, initStats, invRestMat, k, len1, light, orbitControls, planeGeo, planeMat, planeObj, ref, ref1, render, renderer, restCm, restVolume, scene, stats, trans, updatePlaneConstrains, v, wnv, x0,
  ...
  render = function() {
    var corrects, corrs, delta, i, l, len2, len3, m, ref2, ref3, volume;
